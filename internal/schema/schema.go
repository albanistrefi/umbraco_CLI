...
var Templates = map[string]any{
	...
	"member.create": map[string]any{
		...
		"password":               "<string, required at create time; passwordConfiguration is server-side>",
		...
		"isTwoFactorEnabled":     "<boolean, optional, defaults to false>",
		"groups":                 []any{"<member group GUID from 'member-group list'>"},
		"failedPasswordAttempts": "<number, optional, defaults to 0>",
		"values": []any{map[string]any{
