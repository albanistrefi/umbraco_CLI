...
var endpointBindings = map[string]endpointBinding{
	...
	"doctype.create-folder":      {Method: "POST", Path: "/document-type/folder"},
	"doctype.delete-folder":      {Method: "DELETE", Path: "/document-type/folder/{id}"},
	...
	"datatype.create-folder": {Method: "POST", Path: "/data-type/folder"},
	"datatype.delete-folder": {Method: "DELETE", Path: "/data-type/folder/{id}"},
	"doctype.restore-backup": {Manual: &rawSchema{Method: "PUT", Path: "/document-type/{id}", RequestBody: &ObjectSchema{Type: "object", Description: "CLI workflow: PUT the type captured by --backup back, then re-read and verify its properties are present"}}},

	// datatype
	"datatype.restore-backup": {Manual: &rawSchema{Method: "PUT", Path: "/data-type/{id}", RequestBody: &ObjectSchema{Type: "object", Description: "CLI workflow: PUT the data type captured by --backup back, then re-read and verify"}}},
	...
	"mediatype.create-folder":   {Method: "POST", Path: "/media-type/folder"},
	"mediatype.delete-folder":   {Method: "DELETE", Path: "/media-type/folder/{id}"},
	...
	"membertype.create-folder":  {Method: "POST", Path: "/member-type/folder"},
	"membertype.delete-folder":  {Method: "DELETE", Path: "/member-type/folder/{id}"},
	"mediatype.restore-backup":  {Manual: &rawSchema{Method: "PUT", Path: "/media-type/{id}", RequestBody: &ObjectSchema{Type: "object", Description: "CLI workflow: PUT the type captured by --backup back, then re-read and verify its properties are present"}}},
	"membertype.restore-backup": {Manual: &rawSchema{Method: "PUT", Path: "/member-type/{id}", RequestBody: &ObjectSchema{Type: "object", Description: "CLI workflow: PUT the type captured by --backup back, then re-read and verify its properties are present"}}},
