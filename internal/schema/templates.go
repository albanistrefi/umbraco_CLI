...
var Templates = map[string]any{
	"blueprint.create": map[string]any{
		"id":           "<uuid, optional; generated by CLI when omitted>",
		"documentType": map[string]any{"id": "<document type id, required>"},
		"parent":       map[string]any{"id": "<blueprint FOLDER id, optional; omit for the tree root. Create folders with 'blueprint create-folder'>"},
		"variants": []any{map[string]any{
			"name":    "<string, required; this is the blueprint's name in the tree>",
			"culture": "<culture, optional>",
		}},
		"values": []any{map[string]any{
			"alias":   "<property alias>",
			"value":   "<preset property value>",
			"culture": "<culture, optional>",
		}},
	},
	...
	"doctype.create": map[string]any{
		...
		"parent":               map[string]any{"id": "<document type FOLDER id, optional; omit for the tree root. Create folders with 'doctype create-folder'>"},
		"allowedAsRoot":        "<boolean>",
		"variesByCulture":      "<boolean>",
		"variesBySegment":      "<boolean>",
		"isElement":            "<boolean, optional; true creates an element type (no own URL, intended for Block List/Grid)>",
		"allowedInLibrary":     "<boolean, optional; Umbraco 18.1+ element library>",
		...
		"allowedDocumentTypes": "<array of {documentType: {id}, sortOrder} entries, optional; the child types allowed under this one>",
		"cleanup":              map[string]any{"preventCleanup": "<boolean>", "keepAllVersionsNewerThanDays": "<int|null>", "keepLatestVersionPerDayForDays": "<int|null>"},
		...
		"properties": []any{map[string]any{
			...
			"variesByCulture": "<boolean>",
			"variesBySegment": "<boolean>",
			"validation":      map[string]any{"mandatory": "<boolean>", "mandatoryMessage": "<string|null>", "regEx": "<string|null>", "regExMessage": "<string|null>"},
			"appearance":      map[string]any{"labelOnTop": "<boolean>"},
		}},
	...
	"datatype.create": map[string]any{
		"id":            "<uuid, optional; generated by CLI when omitted>",
		"name":          "<string, required>",
		"parent":        map[string]any{"id": "<data type FOLDER id, optional; omit for the tree root. Create folders with 'datatype create-folder'>"},
		"editorAlias":   "<property editor alias, e.g. Umbraco.TextBox, required>",
		"editorUiAlias": "<property editor UI alias, e.g. Umb.PropertyEditorUi.TextBox, required>",
		"values": []any{map[string]any{
			"alias": "<setting alias, e.g. maxChars>",
			"value": "<setting value>",
		}},
	},
