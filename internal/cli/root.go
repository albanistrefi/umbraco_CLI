...
func NewRootCommand() *cobra.Command {
	...
	commands.RegisterBlueprint(root, deps)
	...
	commands.RegisterPartialView(root, deps)
	commands.RegisterScript(root, deps)
	commands.RegisterStylesheet(root, deps)
	commands.RegisterStaticFile(root, deps)
